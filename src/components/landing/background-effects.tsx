  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-0 left-1/2 h-[500px] w-[80vw] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,_var(--accent-glow),_transparent_70%)] opacity-50 blur-3xl" />
      </div>
    </>
  );
}
