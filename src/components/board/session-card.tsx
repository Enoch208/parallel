...
const stateStyles: Record<CardState, string> = {
  ...
  cancelled: "border-dashed border-white/15 bg-transparent",
};
...
const stateLabels: Record<CardState, string | null> = {
  ...
  gap: "Needs cover",
  cancelled: "Cancelled by the organizer · repair to replace it",
};
    ...
    >
      ...
      <h4
        className={cx(
          ...
          state === "cancelled" ? "text-neutral-500 line-through" : "text-white",
        )}
      >
        {session.title}
      </h4>
